...
@interface OKLimitedEdition ()
- (void) buildRowsForTableView;
- (void) useExistingAccount;
- (void) createNewAccount;
@end

@implementation OKLimitedEdition
...
- (void) buildRowsForTableView
{
    ...
    //Add section
    NSDictionary *account = [[NSDictionary alloc] initWithObjectsAndKeys:account_rows, @"sectionRows", @"", @"sectionFooter", @"Thank you for purchasing one of the Smooth Second Bastard Limited Editions.\n\nPlease register your app with us so we can confirm your edition number.\n", @"sectionHeader", nil];
