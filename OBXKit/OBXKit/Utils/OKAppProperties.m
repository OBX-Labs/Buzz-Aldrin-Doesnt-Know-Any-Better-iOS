...
@synthesize properties, iPad, iPhone568h, pushed, scale, supportsRetinaFonts;
...
+ (OKAppProperties*) sharedInstance
{
    @synchronized(self)
    {
        if(sharedInstance == nil) {
            ...
            sharedInstance.supportsRetinaFonts = NO;
        }
    }
...
+ (BOOL) doesSupportsRetinaFonts { return [[OKAppProperties sharedInstance] supportsRetinaFonts]; }
