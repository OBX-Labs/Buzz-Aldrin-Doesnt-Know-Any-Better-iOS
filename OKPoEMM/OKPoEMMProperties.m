...
// Properties specific to Know app
NSString* const FontScale = @"FontScale";
NSString* const TextBackgroundColor = @"TextBackgroundColor";
NSString* const TextForegroundColor = @"TextForegroundColor";//TextForegroundColor
NSString* const TextFocusedColor = @"TextFocusedColor"; //TextFocusedColor
NSString* const TextOutlineFadedColor = @"TextOutlineFadedColor";
NSString* const TextBackgroundPosition = @"TextBackgroundPosition";
NSString* const TextForegroundPosition = @"TextForegroundPosition";
NSString* const TextWanderBackgroundSpeed = @"TextWanderBackgroundSpeed";
NSString* const TextWanderDraggingSpeed = @"TextWanderDraggingSpeed";
NSString* const TextWanderFocusSpeed = @"TextWanderFocusSpeed";
NSString* const TextWanderBackgroundRadius = @"TextWanderBackgroundRadius";
NSString* const TextWanderDraggingRadius = @"TextWanderDraggingRadius";
NSString* const TextWanderFocusRadius = @"TextWanderFocusRadius";
NSString* const TextWanderFriction = @"TextWanderFriction";
NSString* const Fog = @"Fog";
NSString* const FogColor = @"FogColor";
NSString* const FogStartPositon = @"FogStartPosition";
NSString* const FogEndPosition = @"FogEndPosition";
