...
// specif to Know app
extern NSString* const FontScale;
extern NSString* const TextBackgroundColor;
extern NSString* const TextForegroundColor;//TextForegroundColor
extern NSString* const TextFocusedColor; //TextFocusedColor
extern NSString* const TextOutlineFadedColor;
extern NSString* const TextBackgroundPosition;
extern NSString* const TextForegroundPosition;
extern NSString* const TextWanderBackgroundSpeed;
extern NSString* const TextWanderDraggingSpeed;
extern NSString* const TextWanderFocusSpeed;
extern NSString* const TextWanderBackgroundRadius;
extern NSString* const TextWanderDraggingRadius;
extern NSString* const TextWanderFocusRadius;
extern NSString* const TextWanderFriction;
extern NSString* const Fog;
extern NSString* const FogColor;
extern NSString* const FogStartPositon;
extern NSString* const FogEndPosition;
